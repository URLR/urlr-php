...
class AccessTokensApi
{
    ...
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\URLR\Model\CreateAccessToken200Response' === '\SplFileObject') {
                ...
                case 401:
                    if ('\URLR\Model\CreateAccessToken401Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
    ...
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 401:
                    if ('\URLR\Model\RefreshAccessToken401Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
