...
class FoldersApi
{
     ...
     * Create a folder
     *
     * @param  \URLR\Model\CreateFolderRequest|null $createFolderRequest You can use this endpoint to add a folder to URLR. (optional)
     ...
     * @return \URLR\Model\CreateFolder200Response|\URLR\Model\GetLink401Response|\URLR\Model\CreateLink429Response|\URLR\Model\CreateFolder409Response
     */
    public function createFolder(
        ?\URLR\Model\CreateFolderRequest $createFolderRequest = null,
        string $contentType = self::contentTypes['createFolder'][0]
    ): \URLR\Model\CreateFolder200Response|\URLR\Model\GetLink401Response|\URLR\Model\CreateLink429Response|\URLR\Model\CreateFolder409Response
    {
        list($response) = $this->createFolderWithHttpInfo($createFolderRequest, $contentType);
        return $response;
    }
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \URLR\Model\CreateFolder200Response|\URLR\Model\GetLink401Response|\URLR\Model\CreateLink429Response|\URLR\Model\CreateFolder409Response, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $request = $this->createFolderRequest($createFolderRequest, $contentType);
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\URLR\Model\CreateFolder200Response',
                        $request,
                        $response,
                    );
                case 401:
                ...
                case 409:
                    return $this->handleResponseWithDataType(
                        '\URLR\Model\CreateFolder409Response',
                        $request,
                        $response,
                    );
            }
    ...
    {
        return $this->createFolderAsyncWithHttpInfo($createFolderRequest, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    {
        $returnType = '\URLR\Model\CreateFolder200Response';
        $request = $this->createFolderRequest($createFolderRequest, $contentType);
    ...
    ): Request
    {
        ...
        // for model (json/xml)
        if (isset($createFolderRequest)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($createFolderRequest));
            } else {
                $httpBody = $createFolderRequest;
            }
     ...
     *
     * @param  string $teamId Workspace API ID (required)
