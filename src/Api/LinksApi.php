...
class LinksApi
{
     ...
     * @return \URLR\Model\Link|\URLR\Model\GetLink401Response|\URLR\Model\GetLink422Response|\URLR\Model\CreateLink429Response|\URLR\Model\EditLink500Response
     */
    public function createLink(
        ?\URLR\Model\CreateLinkRequest $createLinkRequest = null,
        string $contentType = self::contentTypes['createLink'][0]
    ): \URLR\Model\Link|\URLR\Model\GetLink401Response|\URLR\Model\GetLink422Response|\URLR\Model\CreateLink429Response|\URLR\Model\EditLink500Response
    {
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \URLR\Model\Link|\URLR\Model\GetLink401Response|\URLR\Model\GetLink422Response|\URLR\Model\CreateLink429Response|\URLR\Model\EditLink500Response, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \URLR\Model\Link|\URLR\Model\GetLink401Response|\URLR\Model\GetLink422Response|\URLR\Model\EditLink500Response
     */
    public function editLink(
        string $linkId,
        ?\URLR\Model\EditLinkRequest $editLinkRequest = null,
        string $contentType = self::contentTypes['editLink'][0]
    ): \URLR\Model\Link|\URLR\Model\GetLink401Response|\URLR\Model\GetLink422Response|\URLR\Model\EditLink500Response
    {
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \URLR\Model\Link|\URLR\Model\GetLink401Response|\URLR\Model\GetLink422Response|\URLR\Model\EditLink500Response, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \URLR\Model\Link|\URLR\Model\GetLink404Response|\URLR\Model\GetLink401Response|\URLR\Model\GetLink422Response
     */
    public function getLink(
        string $linkId,
        string $contentType = self::contentTypes['getLink'][0]
    ): \URLR\Model\Link|\URLR\Model\GetLink404Response|\URLR\Model\GetLink401Response|\URLR\Model\GetLink422Response
    {
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \URLR\Model\Link|\URLR\Model\GetLink404Response|\URLR\Model\GetLink401Response|\URLR\Model\GetLink422Response, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * List links
     *
     * @param  string|null $teamId Filter by Workspace API ID (optional)
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['listLinks'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \URLR\Model\ListLinks200Response|\URLR\Model\GetLink422Response|\URLR\Model\GetLink404Response|\URLR\Model\GetLink401Response
     */
    public function listLinks(
        ...
        ?int $limit = 10,
        ?int $page = 1,
        string $contentType = self::contentTypes['listLinks'][0]
    ): \URLR\Model\ListLinks200Response|\URLR\Model\GetLink422Response|\URLR\Model\GetLink404Response|\URLR\Model\GetLink401Response
    {
        list($response) = $this->listLinksWithHttpInfo($teamId, $folderId, $tagId, $limit, $page, $contentType);
        return $response;
    }
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \URLR\Model\ListLinks200Response|\URLR\Model\GetLink422Response|\URLR\Model\GetLink404Response|\URLR\Model\GetLink401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function listLinksWithHttpInfo(
        ?string $teamId = null,
        ?string $folderId = null,
        ?string $tagId = null,
        ?int $limit = 10,
    ...
    {
        $request = $this->listLinksRequest($teamId, $folderId, $tagId, $limit, $page, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\URLR\Model\ListLinks200Response',
                        $request,
                        $response,
                    );
                case 422:
     ...
     * @return PromiseInterface
     */
    public function listLinksAsync(
        ?string $teamId = null,
        ?string $folderId = null,
        ?string $tagId = null,
        ?int $limit = 10,
    ...
    {
        return $this->listLinksAsyncWithHttpInfo($teamId, $folderId, $tagId, $limit, $page, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return PromiseInterface
     */
    public function listLinksAsyncWithHttpInfo(
        ?string $teamId = null,
        ?string $folderId = null,
        ?string $tagId = null,
        ?int $limit = 10,
    ...
    {
        $returnType = '\URLR\Model\ListLinks200Response';
        $request = $this->listLinksRequest($teamId, $folderId, $tagId, $limit, $page, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listLinksRequest(
        ?string $teamId = null,
        ?string $folderId = null,
        ?string $tagId = null,
        ?int $limit = 10,
    ...
    ): Request
    {
        ...
        if ($limit !== null && $limit > 50) {
            throw new InvalidArgumentException('invalid value for "$limit" when calling LinksApi.listLinks, must be smaller than or equal to 50.');
        }
        if ($limit !== null && $limit < 10) {
            throw new InvalidArgumentException('invalid value for "$limit" when calling LinksApi.listLinks, must be bigger than or equal to 10.');
        }
        
        if ($page !== null && $page < 1) {
            throw new InvalidArgumentException('invalid value for "$page" when calling LinksApi.listLinks, must be bigger than or equal to 1.');
        }
