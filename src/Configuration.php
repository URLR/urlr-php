...
class Configuration
{
     ...
     * @var string
     */
    protected string $userAgent = 'OpenAPI-Generator/2.13.0/PHP';
    ...
    public static function toDebugReport(): string
    {
        ...
        $report .= '    The version of the OpenAPI document: 1.12' . PHP_EOL;
        $report .= '    SDK Package Version: 2.13.0' . PHP_EOL;
