...
class Configuration
{
     ...
     * @var string
     */
    protected string $host = 'https://urlr.me/api/v2';
     ...
     * @var string
     */
    protected string $userAgent = 'OpenAPI-Generator/3.2.1/PHP';
    ...
    {
        $report  = 'PHP SDK (URLR) Debug Report:' . PHP_EOL;
