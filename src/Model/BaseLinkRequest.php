...
/**
 * BaseLinkRequest Class Doc Comment
 *
 * @package  URLR
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class BaseLinkRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'BaseLinkRequest';
    ...
    public function setUrl(?string $url): static
    {
        ...
        if ((mb_strlen($url) > 4096)) {
            throw new InvalidArgumentException('invalid length for $url when calling BaseLinkRequest., must be smaller than or equal to 4096.');
        }
    ...
    public function setCode(?string $code): static
    {
        ...
        if ((!preg_match("/^[a-zA-Z0-9!-]{2,50}$/", ObjectSerializer::toString($code)))) {
            throw new InvalidArgumentException("invalid value for \$code when calling BaseLinkRequest., must conform to the pattern /^[a-zA-Z0-9!-]{2,50}$/.");
        }
    ...
    public function setTags(?array $tags): static
    {
        ...
        if ((count($tags) > 3)) {
            throw new InvalidArgumentException('invalid value for $tags when calling BaseLinkRequest., number of items must be less than or equal to 3.');
        }
