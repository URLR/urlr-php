...
class CreateLinkRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'CreateLinkRequest';
    ...
    public function setUrl(string $url): static
    {
        ...
        if ((mb_strlen($url) > 4096)) {
            throw new InvalidArgumentException('invalid length for $url when calling CreateLinkRequest., must be smaller than or equal to 4096.');
        }
