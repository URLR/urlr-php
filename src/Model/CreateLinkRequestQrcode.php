...
/**
 * CreateLinkRequestQrcode Class Doc Comment
 *
 * @description QR Code
 * @package  URLR
 * @author   OpenAPI Generator team
 ...
 */
class CreateLinkRequestQrcode implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'createLink_request_qrcode';
    ...
    */
    ...
    public function setSize(?int $size): static
    {
        ...
        if (($size > 1000)) {
            throw new InvalidArgumentException('invalid value for $size when calling CreateLinkRequestQrcode., must be smaller than or equal to 1000.');
        }
        if (($size < 100)) {
            throw new InvalidArgumentException('invalid value for $size when calling CreateLinkRequestQrcode., must be bigger than or equal to 100.');
        }
