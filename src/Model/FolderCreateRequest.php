...
/**
 * FolderCreateRequest Class Doc Comment
 *
 * @package  URLR
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class FolderCreateRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'folderCreate_request';
    ...
    public function setName(string $name): static
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new InvalidArgumentException('invalid length for $name when calling FolderCreateRequest., must be smaller than or equal to 255.');
        }
     ...
     * Sets parentId
     *
     * @param string|null $parentId Folder API ID
     *
     * @return $this
     */
