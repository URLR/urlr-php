    ...
    */
    ...
    public function setTitle(?string $title): static
    {
        ...
        if ((mb_strlen($title) > 255)) {
            throw new InvalidArgumentException('invalid length for $title when calling GetLink200ResponseMetatag., must be smaller than or equal to 255.');
        }
    ...
    public function setDescription(?string $description): static
    {
        ...
        if ((mb_strlen($description) > 255)) {
            throw new InvalidArgumentException('invalid length for $description when calling GetLink200ResponseMetatag., must be smaller than or equal to 255.');
        }
