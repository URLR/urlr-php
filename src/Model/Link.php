...
class Link implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    protected static array $openAPITypes = [
        ...
        'tags' => '\URLR\Model\LinkTagsInner[]',
        'qrcode' => '\URLR\Model\LinkQrcode',
        'utm' => '\URLR\Model\LinkUtm',
        'metatag' => '\URLR\Model\LinkMetatag',
    ...
    public function setCode(?string $code): static
    {
        ...
        if ((mb_strlen($code) > 50)) {
            throw new InvalidArgumentException('invalid length for $code when calling Link., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($code) < 2)) {
            throw new InvalidArgumentException('invalid length for $code when calling Link., must be bigger than or equal to 2.');
        }
    ...
    public function setLabel(?string $label): static
    {
        ...
        if ((mb_strlen($label) > 255)) {
            throw new InvalidArgumentException('invalid length for $label when calling Link., must be smaller than or equal to 255.');
        }
     ...
     * Sets password
     *
     * @param string|null $password Password: \"**********\" means a password exists; null means no password.
     *
     * @return $this
     */
    public function setPassword(?string $password): static
    {
        ...
        if ((mb_strlen($password) > 255)) {
            throw new InvalidArgumentException('invalid length for $password when calling Link., must be smaller than or equal to 255.');
        }
     ...
     * Gets tags
     *
     * @return \URLR\Model\LinkTagsInner[]|null
     */
     ...
     * Sets tags
     *
     * @param \URLR\Model\LinkTagsInner[]|null $tags Tags
     *
     * @return $this
     */
    public function setTags(?array $tags): static
    {
        ...
        if ((count($tags) > 3)) {
            throw new InvalidArgumentException('invalid value for $tags when calling Link., number of items must be less than or equal to 3.');
        }
     ...
     * Gets qrcode
     *
     * @return \URLR\Model\LinkQrcode|null
     */
    public function getQrcode(): ?\URLR\Model\LinkQrcode
    {
     ...
     * Sets qrcode
     *
     * @param \URLR\Model\LinkQrcode|null $qrcode qrcode
     *
     * @return $this
     */
    public function setQrcode(?\URLR\Model\LinkQrcode $qrcode): static
    {
        if (is_null($qrcode)) {
     ...
     * Gets metatag
     *
     * @return \URLR\Model\LinkMetatag|null
     */
    public function getMetatag(): ?\URLR\Model\LinkMetatag
    {
     ...
     * Sets metatag
     *
     * @param \URLR\Model\LinkMetatag|null $metatag metatag
     *
     * @return $this
     */
    public function setMetatag(?\URLR\Model\LinkMetatag $metatag): static
    {
        if (is_null($metatag)) {
