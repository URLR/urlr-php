...
class LinkBaseRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    public function setCode(?string $code): static
    {
        ...
        if ((mb_strlen($code) > 50)) {
            throw new InvalidArgumentException('invalid length for $code when calling LinkBaseRequest., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($code) < 2)) {
            throw new InvalidArgumentException('invalid length for $code when calling LinkBaseRequest., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/^[\\p{L}0-9_\\-\/]{2,50}$/", ObjectSerializer::toString($code)))) {
            throw new InvalidArgumentException("invalid value for \$code when calling LinkBaseRequest., must conform to the pattern /^[\\p{L}0-9_\\-\/]{2,50}$/.");
        }
    ...
    public function setLabel(?string $label): static
    {
        ...
        if ((mb_strlen($label) > 255)) {
            throw new InvalidArgumentException('invalid length for $label when calling LinkBaseRequest., must be smaller than or equal to 255.');
        }
    ...
    public function setPassword(?string $password): static
    {
        ...
        if ((mb_strlen($password) > 255)) {
            throw new InvalidArgumentException('invalid length for $password when calling LinkBaseRequest., must be smaller than or equal to 255.');
        }
