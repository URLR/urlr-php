...
/**
 * LinkEditRequest Class Doc Comment
 *
 * @package  URLR
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class LinkEditRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'LinkEditRequest';
    ...
    public function setUrl(?string $url): static
    {
        ...
        if ((mb_strlen($url) > 4096)) {
            throw new InvalidArgumentException('invalid length for $url when calling LinkEditRequest., must be smaller than or equal to 4096.');
        }
    ...
    public function setCode(?string $code): static
    {
        ...
        if ((mb_strlen($code) > 50)) {
            throw new InvalidArgumentException('invalid length for $code when calling LinkEditRequest., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($code) < 2)) {
            throw new InvalidArgumentException('invalid length for $code when calling LinkEditRequest., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/^[\\p{L}0-9_\\-\/]{2,50}$/", ObjectSerializer::toString($code)))) {
            throw new InvalidArgumentException("invalid value for \$code when calling LinkEditRequest., must conform to the pattern /^[\\p{L}0-9_\\-\/]{2,50}$/.");
        }
    ...
    public function setLabel(?string $label): static
    {
        ...
        if ((mb_strlen($label) > 255)) {
            throw new InvalidArgumentException('invalid length for $label when calling LinkEditRequest., must be smaller than or equal to 255.');
        }
    ...
    public function setPassword(?string $password): static
    {
        ...
        if ((mb_strlen($password) > 255)) {
            throw new InvalidArgumentException('invalid length for $password when calling LinkEditRequest., must be smaller than or equal to 255.');
        }
    ...
    public function setTags(?array $tags): static
    {
        ...
        if ((count($tags) > 3)) {
            throw new InvalidArgumentException('invalid value for $tags when calling LinkEditRequest., number of items must be less than or equal to 3.');
        }
