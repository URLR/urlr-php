 ...
 */
class QrcodeCreateRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'qrcodeCreate_request';
    ...
    public function setSize(?int $size): static
    {
        ...
        if (($size > 1000)) {
            throw new InvalidArgumentException('invalid value for $size when calling QrcodeCreateRequest., must be smaller than or equal to 1000.');
        }
        if (($size < 100)) {
            throw new InvalidArgumentException('invalid value for $size when calling QrcodeCreateRequest., must be bigger than or equal to 100.');
        }
