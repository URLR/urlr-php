...
/**
 * ReduceLink200Response Class Doc Comment
 *
 * @package  URLR
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ReduceLink200Response implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'reduceLink_200_response';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('urlCode', $data ?? [], null);
    ...
    */
     ...
     * Sets url
     *
     * @param string|null $url Input url to reduce
     *
     * @return $this
     */
    ...
    {
        return $this->container['urlCode'];
    }

    /**
     * Sets urlCode
     *
     * @param string|null $urlCode urlCode
     *
     * @return $this
     */
    ...
    {
        if (is_null($urlCode)) {
            throw new InvalidArgumentException('non-nullable urlCode cannot be null');
        }
        $this->container['urlCode'] = $urlCode;
